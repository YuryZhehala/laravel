...
{!!csrf_field()!!}
    <div class="form-group" {{$errors->has('surname')?'has-error':''}}>
      ...
      <input type="text" id="disabledTextInput" name="surname" class="form-control"  value="{{isset($obj)?$obj->surname:old('surname')}}">
    ...
    <div class="form-group" {{$errors->has('nick')?'has-error':''}}>
      ...
      <input type="text" id="disabledTextInput" name="nick" class="form-control"  value="{{isset($obj)?$obj->nick:old('nick')}}">
      @if($errors->has('nick'))
    <span class = "help-block">
    <b>{{$errors->first('nick')}}</b>
    @endif
    </div>
    <div class="form-group" {{$errors->has('phone')?'has-error':''}}>
      <label for="disabledTextInput">Контактный телефон</label>
      <input type="text" id="disabledTextInput" name="phone" class="form-control" value="{{isset($obj)?$obj->phone:old('phone')}}">
      @if($errors->has('phone'))
    <span class = "help-block">
    ...
    <div class="form-group" {{$errors->has('about')?'has-error':''}}>
      ...
      <textarea class="form-control ckeditor" name="about" id="editor1">{{isset($obj)?$obj->about:old('about')}}</textarea>
      @if($errors->has('about'))
    <span class = "help-block">
    <b>{{$errors->first('about')}}</b>
    @endif
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" id="disabledTextInput" name="city" class="form-control" value="{{isset($obj)?$obj->city:old('city')}}">          
    </div>
    <div class="form-group">
